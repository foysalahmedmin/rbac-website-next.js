...
import { Activity, Briefcase, ListTodo, Users } from "lucide-react";
        ...
        {hasPermission("view_leads") && (
          <Card className="bg-card border-border backdrop-blur-xl">
            ...
            <CardContent>
              ...
              <p className="text-xs text-primary mt-1">12 new leads today</p>
            </CardContent>
          </Card>
        )}
        {hasPermission("view_tasks") && (
          <Card className="bg-card border-border backdrop-blur-xl">
            ...
            <CardContent>
              ...
              <p className="text-xs text-secondary mt-1">5 overdue tasks</p>
            </CardContent>
          </Card>
        )}
        <Card className="bg-card border-border backdrop-blur-xl">
